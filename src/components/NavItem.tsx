...
export const NavItem = ({ pageName }: { pageName: string }) => {
  ...
  return (
    <li
      className={`text-almost-black dark:text-white transition-all duration-300 border-2 border-transparent hover:border-almost-black hover:bg-almost-black hover:text-white dark:hover:bg-white dark:hover:text-black dark:hover:border-white rounded-2xl ${
